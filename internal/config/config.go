...
func FromEnv() (Config, error) {
	...
	acpMaxPrompts, err := getenvInt("AGENTDOCK_ACP_MAX_CONCURRENT_PROMPTS", 2)
	if err != nil {
		return Config{}, err
	}
	acpInteractionMS, err := getenvInt("AGENTDOCK_ACP_INTERACTION_TIMEOUT_MS", 300000)
	if err != nil {
		return Config{}, err
	}
	return Config{
		...
		ACPAgentName:      getenv("AGENTDOCK_ACP_AGENT", "claude"),
